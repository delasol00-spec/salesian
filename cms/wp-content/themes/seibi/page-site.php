    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-8 col-md-6">
        ...
        <ol>
          ...
          <li>上記各項目の他、法律、条例、規則を含む法令または公序良俗に違反する行為、本ウェブサイトの運営を妨害するおそれのあるウェブサイト。</li>
        ...
        <p>
          ...
          また、当該リンク（本校関係者、非関係者によるものを問わず）によって、本校がそれらの他のウェブサイトの内容、動作または運営主体を承認したことを意味するものではありません。
        </p>
      </div>
    </div>
  </div>
