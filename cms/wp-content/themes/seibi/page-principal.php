  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <img src="<?php echo get_template_directory_uri(); ?>/img/about/principal.webp" class="img-fluid" loading="lazy" alt="星美学園小学校 学校長　星野 和江" />
      </div>
      <div class="col-lg-8 col-md-6">
        <p>
          星美学園は、キリスト教的な人間観・世界観により、創立者聖ヨハネ・ボスコと聖マリア・マザレロが実践した理性・宗教・慈愛に基づく「予防教育法による全人間教育」を行うために創設されたカトリックミッションスクールです。<br />
