    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-8 col-12 mb-5">
        <ul class="examinee-blog-list">
          ...
          $examinee_query = new WP_Query( $args );
          if ( $examinee_query->have_posts() ) :
              while ( $examinee_query->have_posts() ) : $examinee_query->the_post(); ?>
              <li>
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-12">
              ...
              <p>私は将来、ニュース番組に携わり、世界中で、目を向けられていない状況で苦しんでいるような人々にも、多くの人の目が向けられる契機となるような報道をしていきたいと考えています。<br>
                そう思うようになったのは、星美学園で英語を好きになったこと、そして星美学園のカトリックの教えを通して、困っている人々の存在を知ろうとする、また助けようと努
                力する姿勢を身につけることができたからであると感じています。<br>
